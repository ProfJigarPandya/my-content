...
BOOL CMainFrame::OnCreateClient(LPCREATESTRUCT lpcs, CCreateContext* pContext) 
{
	...
	m_SplitterWnd.CreateView(0,0,RUNTIME_CLASS(CSelectSDView),CSize(170,100),pContext);
	m_SplitterWnd.CreateView(0,1,RUNTIME_CLASS(CDSPView),CSize(350,400),pContext);
