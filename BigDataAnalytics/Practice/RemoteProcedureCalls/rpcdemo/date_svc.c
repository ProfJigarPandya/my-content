...
static long *
_bin_date_1 (void  *argp, struct svc_req *rqstp)
{
	return (bin_date_1_svc(rqstp));
}

static char **
_str_date_1 (long  *argp, struct svc_req *rqstp)
{
	return (str_date_1_svc(*argp, rqstp));
}
...
date_prog_1(struct svc_req *rqstp, register SVCXPRT *transp)
{
	...
	case BIN_DATE:
		...
		local = (char *(*)(char *, struct svc_req *)) _bin_date_1;
		break;

	case STR_DATE:
		_xdr_argument = (xdrproc_t) xdr_long;
		_xdr_result = (xdrproc_t) xdr_wrapstring;
		local = (char *(*)(char *, struct svc_req *)) _str_date_1;
		break;
